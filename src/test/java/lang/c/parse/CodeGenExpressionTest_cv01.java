...
public class CodeGenExpressionTest_cv01 {
    ...
    @Test
    public void codeGenExpressionSub4Term() throws FatalErrorException {
        inputStream.setInputString("13+7-3");
        String expected[] = {
            "	MOV	#13, (R6)+",
            "	MOV	#7, (R6)+",
    ...
    @Test
    public void codeGenExpressionSub6Term() throws FatalErrorException {
    ...
    @Test
    public void codeGenExpressionSub7Term() throws FatalErrorException {
